...
== Deleting multiple people : `multidelete`

Deletes the specified person from the address book. Irreversible. +
Format: `multidelete INDEX1 INDEX2 INDEX3 ..... INDEXP`, where P is any integer.

****
Deletes the people at all the specified indices.
The index refers to the index number shown in the most recent listing.
****
